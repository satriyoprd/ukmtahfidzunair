    ...
    <section id="dashboard" class="mt-5 pb-0">
        <div class="container">
            ...
            @if ($status == '1')
                ...
                <div class="mt-8">
                    Selamat Anda telah dinyatakan lulus dalam Kegiatan Ujian Sertifikasi UKM Tahfidz Universitas
                    Airlangga
                    dan berhak mendapatkan beasiswa dari kami. Silakan segera melakukan daftar ulang dan tergabung ke
                    Whatsapp Group untuk mengikuti arahan berikutnya. Link WAG: https://chat.whatsapp.com
                </div>
            @endif
